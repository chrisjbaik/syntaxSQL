...
_PROTOQUERY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='limit', full_name='ProtoQuery.limit', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='from', full_name='ProtoQuery.from', index=12,
...
_PROTOQUERY.fields_by_name['from'].message_type = _PROTOJOINPATH
